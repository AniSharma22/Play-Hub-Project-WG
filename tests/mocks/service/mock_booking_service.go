...
// Source: C:\Users\Dell\projects\watchguard\Play-Hub-Project-WG\internal\domain\interfaces\service\booking_service.go
...
func (m *MockBookingService) MakeBooking(ctx context.Context, userID, slotID, gameID uuid.UUID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MakeBooking", ctx, userID, slotID, gameID)
	ret0, _ := ret[0].(error)
	return ret0
}

// MakeBooking indicates an expected call of MakeBooking.
func (mr *MockBookingServiceMockRecorder) MakeBooking(ctx, userID, slotID, gameID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MakeBooking", reflect.TypeOf((*MockBookingService)(nil).MakeBooking), ctx, userID, slotID, gameID)
}
