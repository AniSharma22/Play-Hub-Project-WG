...
// Source: C:\Users\Dell\projects\watchguard\Play-Hub-Project-WG\internal\domain\interfaces\service\invitation_service.go
...
func (m *MockInvitationService) MakeInvitation(ctx context.Context, invitingUserID, invitedUserID, slotId, gameID uuid.UUID) (uuid.UUID, error) {
	m.ctrl.T.Helper()
...
func (mr *MockInvitationServiceMockRecorder) MakeInvitation(ctx, invitingUserID, invitedUserID, slotId, gameID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MakeInvitation", reflect.TypeOf((*MockInvitationService)(nil).MakeInvitation), ctx, invitingUserID, invitedUserID, slotId, gameID)
}
