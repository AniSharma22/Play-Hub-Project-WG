...
// Source: C:\Users\Dell\projects\watchguard\Play-Hub-Project-WG\internal\domain\interfaces\service\game_service.go
...
func (m *MockGameService) UpdateGameStatus(ctx context.Context, id uuid.UUID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateGameStatus", ctx, id)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateGameStatus indicates an expected call of UpdateGameStatus.
func (mr *MockGameServiceMockRecorder) UpdateGameStatus(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateGameStatus", reflect.TypeOf((*MockGameService)(nil).UpdateGameStatus), ctx, id)
}
