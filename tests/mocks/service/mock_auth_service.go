...
// Source: C:\Users\Dell\projects\watchguard\Play-Hub-Project-WG\internal\domain\interfaces\service\auth_service.go
...
func (m *MockAuthService) Login(ctx context.Context, email string, password []byte) (*entities.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockAuthService) Signup(ctx context.Context, user *entities.User) (*entities.User, error) {
	m.ctrl.T.Helper()
